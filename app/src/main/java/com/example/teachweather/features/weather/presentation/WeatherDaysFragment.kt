...
import com.example.teachweather.databinding.FragmentWeatherDaysBinding
...
@AndroidEntryPoint
class WeatherDaysFragment : Fragment(R.layout.fragment_weather_days) {
    private val viewBinding: FragmentWeatherDaysBinding by viewBinding(FragmentWeatherDaysBinding::bind)
    private val daysViewModel: WeatherDaysViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        daysViewModel.currentCity.observe(viewLifecycleOwner, {
        ...
        daysViewModel.setCurrentCity("${addresses.countryName}, ${addresses.locality}")
        daysViewModel.forecastWeek.observe(viewLifecycleOwner, {
//            viewBinding.tvDays.text = "${it.size} ${resources.getString(R.string.days)}"
//            viewBinding.tvDays.setOnClickListener{
//               findNavController().navigate(R.id.fragment_weather_days)
//           }
//            val firstHour = it[0]
